...
pub use crate::pac::rcc::vals::{
    Hpre as AHBPrescaler, Pllmul as PllMul, Ppre as APBPrescaler, Sw as Sysclk,
};
#[cfg(stm32f107)]
pub use crate::pac::rcc::vals::{
    I2s2src, Pll2mul as Pll2Mul, Prediv1 as PllPreDiv, Prediv1src, Usbpre as UsbPre,
};
    ...
    let adc = {
        ...
        match config.adc {
            ...
            AdcClockSource::Hclk(adcpres) => {
                assert!(
                    !(adcpres == AdcHclkPrescaler::Div1 && config.ahb_pre != AHBPrescaler::DIV1)
                );
