...
use super::low_level::{
    CountingMode, FilterValue, InputCaptureMode, InputTISelection, SlaveMode, Timer,
    TriggerSource as Ts,
};
use super::{
    CaptureCompareInterruptHandler, Channel, ExternalTriggerPin, GeneralInstance4Channel, TimerPin,
};
...
impl<'d, T: GeneralInstance4Channel> OnePulse<'d, T> {
    ...
    pub fn new_ch1(
        ...
        this.inner
            .set_input_capture_filter(Channel::Ch1, FilterValue::NO_FILTER);
        this.inner
            .set_input_capture_mode(Channel::Ch1, capture_mode);
        this.new_inner(freq, pulse_end, counting_mode);
    ...
    pub fn new_ch2(
        ...
        this.inner
            .set_input_capture_mode(Channel::Ch2, capture_mode);
        this.new_inner(freq, pulse_end, counting_mode);
