...
impl From<OutputCompareMode> for stm32_metapac::timer::vals::Ocm {
    fn from(mode: OutputCompareMode) -> Self {
        match mode {
            ...
            OutputCompareMode::InactiveOnMatch => {
                stm32_metapac::timer::vals::Ocm::INACTIVE_ON_MATCH
            }
