...
impl Registers {
    ...
    pub fn set_global_filter(&self, filter: GlobalFilter) {
        let anfs = match filter.handle_standard_frames {
            crate::can::fd::config::NonMatchingFilter::IntoRxFifo0 => {
                stm32_metapac::can::vals::Anfs::ACCEPT_FIFO_0
            }
            crate::can::fd::config::NonMatchingFilter::IntoRxFifo1 => {
                stm32_metapac::can::vals::Anfs::ACCEPT_FIFO_1
            }
            crate::can::fd::config::NonMatchingFilter::Reject => {
                stm32_metapac::can::vals::Anfs::REJECT
            }
        };
        let anfe = match filter.handle_extended_frames {
            crate::can::fd::config::NonMatchingFilter::IntoRxFifo0 => {
                stm32_metapac::can::vals::Anfe::ACCEPT_FIFO_0
            }
            crate::can::fd::config::NonMatchingFilter::IntoRxFifo1 => {
                stm32_metapac::can::vals::Anfe::ACCEPT_FIFO_1
            }
            crate::can::fd::config::NonMatchingFilter::Reject => {
                stm32_metapac::can::vals::Anfe::REJECT
            }
        };
...
fn make_id(id: u32, extended: bool) -> embedded_can::Id {
    if extended {
        ...
        embedded_can::Id::from(unsafe {
            embedded_can::StandardId::new_unchecked(((id >> 18) & 0x000007FF) as u16)
        })
    }
}
