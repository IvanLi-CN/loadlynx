...
- Approved state gallery: `./assets/dashboard-extended-voltage-states-v1.png`.
- Safe5V-only state: `./assets/dashboard-safe5v-only-v1.png`.
- Extended-voltage enabled state: `./assets/dashboard-extended-voltage-on-v1.png`.
- Negotiation error state: `./assets/dashboard-extended-voltage-error-v1.png`.
...
- `docs/specs/usb-pd-sink-toggle/SPEC.md`
- `docs/specs/usb-pd-pps-and-fixed-settings/SPEC.md`
- `docs/specs/dashboard-pd-button-label/SPEC.md`
