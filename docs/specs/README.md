...
| fhpfk | LoadLynx operational skills packaging and workflow boundary | active | `fhpfk-loadlynx-operational-skills/SPEC.md` | `fhpfk-loadlynx-operational-skills/IMPLEMENTATION.md` | PR #78；用户/开发者 skill 场景拆分、CLI-only 硬件操作、USB 优先、硬件记忆门禁、vercel-labs/skills 安装验证 |
