...
| dvfnn | PR Label Release Flow | 待验证 | active | `dvfnn-pr-label-release-flow/SPEC.md` | `dvfnn-pr-label-release-flow/IMPLEMENTATION.md` | 2026-05-29 | PR label release contract、Label Gate、全项目 release assets、发布后 PR 自动评论 |
