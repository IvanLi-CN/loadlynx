...
- Status: 已完成
- Last: 2026-01-03
- Legacy source: `docs/specs/0002-cv-mode-presets/SPEC.md`
- Delete approval: pending

## Background And Scope

Legacy source retained pending delete approval: `docs/specs/0002-cv-mode-presets/SPEC.md`.
...
- 本机 UI 保护字段命名（UVLO/OCP/OPP）：`docs/specs/0006-preset-ui-protection-labels/SPEC.md`
- CC 负载开关语义（enable/target/effective）：`docs/specs/0001-cc-load-switch-toggle/SPEC.md`
