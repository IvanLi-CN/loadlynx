...
- Status: 已完成
- Last: 2026-01-19
- Legacy source: `docs/specs/0019-dashboard-pd-button-label/SPEC.md`
- Delete approval: pending

## Background And Scope

Legacy source retained pending delete approval: `docs/specs/0019-dashboard-pd-button-label/SPEC.md`.
...
- 相关计划：`docs/specs/0013-usb-pd-pps-and-fixed-settings/SPEC.md`、`docs/specs/0016-pd-settings-touch-value-editor/SPEC.md`
