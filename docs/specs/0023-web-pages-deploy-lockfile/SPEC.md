...
- Status: 已完成
- Last: 2026-01-21
- Legacy source: `docs/specs/0023-web-pages-deploy-lockfile/SPEC.md`
- Delete approval: pending

## Background And Scope

Legacy source retained pending delete approval: `docs/specs/0023-web-pages-deploy-lockfile/SPEC.md`.
