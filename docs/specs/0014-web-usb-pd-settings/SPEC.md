...
- Status: 已完成
- Last: 2026-01-13
- Legacy source: `docs/specs/0014-web-usb-pd-settings/SPEC.md`
...
- 不在本计划内实现固件侧的 PD 协议增强与 HTTP API（见 `docs/specs/0013-usb-pd-pps-and-fixed-settings/SPEC.md`）。
...
- `docs/specs/0013-usb-pd-pps-and-fixed-settings/SPEC.md`（固件/UI/UART/HTTP 的 PD 能力与控制契约）
