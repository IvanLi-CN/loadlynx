...
- `docs/specs/0010-usb-pd-sink-toggle/SPEC.md`: 作为历史方案引用时补充指向新 spec 的说明（如仍保留）。
- `docs/specs/0019-dashboard-pd-button-label/SPEC.md`: 作为历史设计依据时补充指向新 spec 的说明（如仍保留）。
...
- `docs/specs/0010-usb-pd-sink-toggle/SPEC.md`
- `docs/specs/0013-usb-pd-pps-and-fixed-settings/SPEC.md`
- `docs/specs/0019-dashboard-pd-button-label/SPEC.md`
