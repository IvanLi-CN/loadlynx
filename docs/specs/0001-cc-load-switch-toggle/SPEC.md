...
- Status: 已完成
- Last: 2025-12-26
- Legacy source: `docs/specs/0001-cc-load-switch-toggle/SPEC.md`
- Delete approval: pending

## Background And Scope

Legacy source retained pending delete approval: `docs/specs/0001-cc-load-switch-toggle/SPEC.md`.
