...
- Status: 已完成
- Last: 2026-01-12
- Legacy source: `docs/specs/0013-usb-pd-pps-and-fixed-settings/SPEC.md`
- Delete approval: pending

## Background And Scope

Legacy source retained pending delete approval: `docs/specs/0013-usb-pd-pps-and-fixed-settings/SPEC.md`.
...
- `docs/specs/0010-usb-pd-sink-toggle/SPEC.md`（PD 最小验证范围，作为演进基础）
