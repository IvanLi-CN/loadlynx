...
- Status: 已完成
- Last: 2025-12-26
- Legacy source: `docs/specs/0011-web-layouts/SPEC.md`
...
- **工具变体（tool）**：顶栏 + 内容区（隐藏常驻侧栏/rail），内容区 **不限制宽度**（用于 Calibration 这类长表格/多列操作）；响应式抽屉入口见 `docs/specs/0012-web-responsive-drawer-sidebar/SPEC.md`。

另见：`docs/specs/0012-web-responsive-drawer-sidebar/SPEC.md`（响应式 drawer / icon rail / 大屏固定侧栏的交互与断点规范）。
