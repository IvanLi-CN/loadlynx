...
- 不包含 Spec `docs/specs/touch-spring-load-switch-rgb-led/SPEC.md` 的语音播放功能测试（`docs/specs/touch-spring-load-switch-rgb-led/SPEC.md` 为独立功能测试项）。
...
- `docs/specs/prompt-tone-manager/SPEC.md`
- `docs/specs/touch-spring-load-switch-rgb-led/SPEC.md`
