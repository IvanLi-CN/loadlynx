...
- 本机 UI 保护字段命名（UVLO/OCP/OPP）：`docs/specs/trrw7-preset-ui-protection-labels/SPEC.md`
- CC 负载开关语义（enable/target/effective）：`docs/specs/y5ztx-cc-load-switch-toggle/SPEC.md`
