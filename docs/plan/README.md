...
| 0017 | CP 模式：本机屏幕界面 + HTTP API | 部分完成（5/6） | `0017:cp-mode-ui-http-api/PLAN.md` | 2026-01-18 | HIL: CP step 10W↔90W @ ~20V: cp_perf enter_tol(3)=5ms (up), 4ms (down) (internal); pending spec-grade scope re-test |
