...
/// Infer the standard EPR fixed 28V selection before live EPR capabilities are available.
///
/// This breaks the SPR->EPR chicken-and-egg: the digital side can persist/send a 28V Fixed
